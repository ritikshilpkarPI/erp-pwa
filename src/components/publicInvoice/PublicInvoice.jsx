        ...
        <div>
            ...
            <div className="invoice-container">
                ...
                <div className="invoice-body">
                    ...
                    <p><strong>SUB TOTAL:</strong> {invoice.totalAmount || 'N/A'}</p>
                    <p><strong>ORDER TIME:</strong> {new Date(invoice.date_of_sale).toLocaleTimeString() || 'N/A'}</p>
                    <p><strong>ORDER DATE:</strong> {new Date(invoice.date_of_sale).toLocaleDateString() || 'N/A'}</p>
                </div>
            </div>
        </div>
    );
